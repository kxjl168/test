...
function ckstyle() { //定义总的风格
	...
	ck.control_c='share.swf,1,1,-180,-100,share.xml?id=[$pat],0';//分享按钮的文件，坐标,相关设置的xml文件,编码0是默认的utf-8,1是gbk2312
    ...
    ck.pm_play = '0,2,0,-30';
    //播放和暂停按钮的坐标
    ck.pm_clock = '0,2,40,-25,110';
    //已播放时间的坐标和宽度
    ck.pm_clock2 = '0,2,40,-25,110';
    //总时间的坐标和宽度
    ...
    ck.pm_buffer = '25,20,0,5,{font color="#FFFFFF"}[$buffer]%{/font}';
